...
zokou({nomCom:"tim",reaction:"😎",categorie:"IA"},async(dest,zk,commandeOptions)=>{

  const {repondre,ms,arg}=commandeOptions;
  
    if(!arg || !arg[0])
    {return repondre("🫵😅 yes im here today i'm reply you🤙....!.")}
    //var quest = arg.join(' ');
  try{
...
.catch(error => {
  ...
  zokou({ nomCom: "ti1", reaction: "🌀", categorie: "IA" }, async (dest, zk, commandeOptions) => {
